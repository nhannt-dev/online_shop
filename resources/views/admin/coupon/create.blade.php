                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="max_uses" id="max_uses" class="form-control" placeholder="Coupon Max Uses">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="max_uses_user">Max Uses User</label>
                                <input type="number" name="max_uses_user" id="max_uses_user" class="form-control" placeholder="Coupon Max Uses User">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="discount_amount">Discount Amount</label>
                                <input type="number" name="discount_amount" id="discount_amount" class="form-control" placeholder="Coupon Discount Amount">
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" name="min_amount" id="min_amount" class="form-control" placeholder="Coupon Min Amount">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea name="description" id="description" cols="30" rows="10" class="form-control" placeholder="Coupon Description"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
