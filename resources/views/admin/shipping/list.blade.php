    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{route('shipping.create')}}" class="btn btn-primary">New Shipping Charge</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$count}}</td>
                            <td>{{$shippingCharge->countryName}}</td>
                            ...
                            <td>
                                ...
                                <a href="javascript:void(0)" onclick="deleteShippingCharge('{{ $shippingCharge->id }}')" class="text-danger w-4 h-4 mr-1">
                        ...
                        @else
                        <tr>
                            <td colspan="4" class="text-center">Shipping Charge Not Found</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
...
<script>
    function deleteShippingCharge(id) {
        var url = '{{route("shipping.delete", "x")}}'
