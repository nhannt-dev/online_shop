                ...
                <div class="col-md-4">
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <select multiple class='related-product w-100' name="related_products[]" id="related_products" class="form-control"></select>
                                <p class="error"></p>
                            </div>
                        </div>
                    </div>
            ...
            var html = `
                <div class="col-md-3" id="image-row-${response.image_id}">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <a href="avascript:void(0)" onclick="deleteImage(${response.image_id})" class="btn btn-danger">Delete</a>
                        </div>
                    </div>
                </div>
            `
